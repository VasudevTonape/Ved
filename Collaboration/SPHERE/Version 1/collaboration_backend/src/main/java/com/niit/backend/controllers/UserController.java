...
public class UserController {
	...
	public ResponseEntity<?> login(@RequestBody User user, HttpSession session) {
		...
		if (validUser == null) {
			...
			if (getUploadFile != null) {
				...
				try {
					String path = "F:/Codes/Eclipse/Collaboration/workspace_dt7_2/collaboration_backend/src/main/webapp/WEB-INF/resources/images/"
							+ user.getUsername();
	...
	public ResponseEntity<?> logout(HttpSession session) {
		...
		if (user != null) {
			...
			try {
				String path = "F:/Codes/Eclipse/Collaboration/workspace_dt7_1/collaboration_backend/src/main/webapp/WEB-INF/resources/images/"
						+ user.getUsername();
				File file = new File(path);

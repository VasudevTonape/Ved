			...
			<div class="title">
				...
				<div data-ng-app="myapp" data-ng-controller="productController" class="cart-table">
					...
					<div data-ng-init="getCart(${cartId})">
						<div>
							<a class="btn btn-default btn-lg pull-right" data-ng-click="clearCart()">
						...
						<table class="table">
							...
							<tr data-ng-repeat="cartitem in cart.cartItem">
								...
								<td>INR {{cartitem.product.productPrice}}</td>
						...
						<h3 class="grandtotal">Grand Price : <strong>INR {{calculateGrandTotal()}}</strong></h3>
					</div>
					...
					<a href="${url}" class="btn btn-default btn-lg pull-right">Checkout </a>

	...
	<div class="bg-img">
		<div class="container">
			...
			<div class="img-txt">
				<div class="container">
					<div
						class="imgforc col-md-3 col-md-offset-2 col-sm-4 col-sm-offset-2 col-xs-12">
						<img src="<c:url value="/resources/images/cont1.jpg"> </c:url>"
							alt="image here" class="img-circle img-responsive" width="300px" />

					</div>

					<div class="address col-md-3 col-md-offset-2 col-sm-3 col-xs-12">
						<strong>Address</strong><br /> #13, 13th floor, <br /> 13th
						cross, 13th main, <br /> 13th Block Jayanagar,<br /> Bengaluru -
						560 000 <br /> <br /> <strong> Phone</strong><br /> +91
						9686554512 <br /> <br /> <strong>E-mail</strong><br />

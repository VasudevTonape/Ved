						...
						<div class="products">
							...
							<div class="eachproduct"
								...
								<div class="image">
									...
									<img class="img-responsive" src="${src }" width="250px" />
								</div>
								...
								<div class="details col-md-offset-5">
									...
									<a class="btn btn-default btn-lg"
										href="getProductsByProductId/{{b.productId }}">View</a>
								</div>
								...
								<div class="foradmin">
									<security:authorize access="hasRole('ROLE_ADMIN')">
										...
										<a class="btn btn-default btn-lg"
											href="admin/delete/{{b.productId}}"><span
											class="glyphicon glyphicon-trash"></span> Delete</a> &nbsp;&nbsp;&nbsp;&nbsp;
										<a class="btn btn-default btn-lg"
											href="admin/product/editProduct/{{b.productId}}"><span

...
<link rel="stylesheet"
	href="<c:url value="/resources/css/invalidCartWarning.css"/>" />
	...
	<div class="bg-img">
		<section>
			<div class="container">
				...
				<div
					class="invalidCart container-fluid col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
					<h1>Invalid Cart!</h1>
					<p>Please check the cart. The cart maybe empty.</p>
				</div>

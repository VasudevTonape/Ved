...
<link rel="stylesheet"
	href="<c:url value="/resources/css/thankCustomer.css"/>" />
	...
	<div class="bg-img">
		<section>
			<div class="container">
				...
				<div
					class="thankyou container-fluid col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">

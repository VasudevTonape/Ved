...
<link rel="stylesheet"
	href="<c:url value="/resources/css/collectCustomerInfo.css"/>" />
</head>
<body>
	...
	<div class="bg-img">
		<section>
			<div class="container">
				...
				<div
					class="collectinfo container-fluid col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
